...
class Prefect(Walker):
    ...
    def move(self):
        ...
        elif any((i.building.owner == self.building.map.name_user and i.risk.type == "fire" and i.risk.fireCounter > 0 and i not in self.currentCell.check_cell_around(Cell.Building))
