...
class Panel():
    ...
    def init_sprites(self):
        ...
        self.window_chat = pygame.image.load(
            "game_screen/game_screen_sprites/panel_window_chat.png").convert_alpha()
        ...
        self.buy_button_sprite = pygame.image.load(
            "game_screen/game_screen_sprites/paneling_buy.png").convert_alpha()
    ...
    def init_buttons(self):
        ...
        self.ownership_button = Button(187*self.width_screen/192, 0.350*self.height_screen,
                                       self.width_screen/48, self.height_screen/40, self.ownership_button_sprite)
        ...
        self.governor_button = Button(179.6*self.width_screen/192, self.height_screen/20,
                                      self.width_screen/22, self.height_screen/12, self.governor_off)
        self.buy_button = Button(182*self.width_screen/192, self.height_screen - self.height_screen /
                                 30, self.width_screen/48, self.height_screen/40, self.buy_button_sprite)
    ...
    def display(self):
        ...
        if self.chatON:
            self.chat.display()
            print([self.chat.message_history[i].text for i in range(
                len(self.chat.message_history))])
    ...
    def set_window(self, choice):
        ...
        if choice == "chat":
            self.window_current = self.window_chat
        if choice == "none":
            self.window_current = self.window_none
        self.screen.blit(pygame.transform.scale(self.window_current, (self.width_screen /
                                                                      12-10, self.height_screen/17)), (11*self.width_screen/12+5, 0.18*self.height_screen))
